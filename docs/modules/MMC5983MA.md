...
The timeout is independently applied to each conversion in a paired reading. Do not call the shared SPI2 devices concurrently without adding a bus-level mutex around complete transactions.
