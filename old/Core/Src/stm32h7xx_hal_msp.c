...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PF11     ------> ADC1_INP2
    */
    GPIO_InitStruct.Pin = SENSE_8V4_Pin|SENSE_5V_SYS_Pin|PYRO_CONT5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = SENSE_3V3_SYS_Pin|PYRO_ARMED_SENSE_Pin|PYRO_CONT1_Pin|PYRO_CONT2_Pin
                          |PYRO_CONT3_Pin|PYRO_CONT4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = SENSE_VIN_PROT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(SENSE_VIN_PROT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PF11     ------> ADC1_INP2
    */
    HAL_GPIO_DeInit(GPIOC, SENSE_8V4_Pin|SENSE_5V_SYS_Pin|PYRO_CONT5_Pin);

    HAL_GPIO_DeInit(GPIOA, SENSE_3V3_SYS_Pin|PYRO_ARMED_SENSE_Pin|PYRO_CONT1_Pin|PYRO_CONT2_Pin
                          |PYRO_CONT3_Pin|PYRO_CONT4_Pin);

    HAL_GPIO_DeInit(SENSE_VIN_PROT_GPIO_Port, SENSE_VIN_PROT_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM15)
  {
    ...
    PE6     ------> TIM15_CH2
    */
    GPIO_InitStruct.Pin = BUZZER_PWM_L_Pin|BUZZER_PWM_H_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM2)
  {
    ...
    PA15 (JTDI)     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(GNSS_PPS_GPIO_Port, GNSS_PPS_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  if(huart->Instance==UART4)
  {
    ...
    PD1     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = EXT1_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART4;
    HAL_GPIO_Init(EXT1_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = EXT1_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART4;
    HAL_GPIO_Init(EXT1_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(huart->Instance==USART6)
  {
    ...
    PG15     ------> USART6_CTS
    */
    GPIO_InitStruct.Pin = BLE_RTS_Pin|BLE_TX_Pin|BLE_CTS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART4)
  {
    ...
    PD1     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOD, EXT1_RX_Pin|EXT1_TX_Pin);
  ...
  else if(huart->Instance==USART6)
  {
    ...
    PG15     ------> USART6_CTS
    */
    HAL_GPIO_DeInit(GPIOG, BLE_RTS_Pin|BLE_RX_Pin|BLE_TX_Pin|BLE_CTS_Pin);
