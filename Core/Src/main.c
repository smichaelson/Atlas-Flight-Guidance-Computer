...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_USB|RCC_PERIPHCLK_ADC
                              ...
                              |RCC_PERIPHCLK_SDMMC|RCC_PERIPHCLK_SPI3
                              |RCC_PERIPHCLK_SPI2|RCC_PERIPHCLK_USART1
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, GPIO_OUT1_Pin|GPIO_OUT7_Pin|GPIO_OUT6_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, GPIO_OUT3_Pin|GPIO_OUT4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, PYRO_FIRE1_Pin|PYRO_FIRE2_Pin|PYRO_FIRE3_Pin|PYRO_FIRE4_Pin
                          |PYRO_FIRE5_Pin|BLE_RESET_N_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, BLE_SWITCH2_Pin|BLE_SWITCH1_Pin|CS_LSM6DSV16B_Pin|CS_MMC5983_Pin
                          |CS_ADXL375_Pin|CS_SPI_EXT_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BLE_DSR_GPIO_Port, BLE_DSR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : GPIO_IN1_Pin GPIO_IN2_Pin GPIO_IN7_Pin */
  GPIO_InitStruct.Pin = GPIO_IN1_Pin|GPIO_IN2_Pin|GPIO_IN7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pin : GPIO_OUT2_Pin */
  GPIO_InitStruct.Pin = GPIO_OUT2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIO_OUT2_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : GPIO_OUT1_Pin GPIO_OUT7_Pin GPIO_OUT6_Pin */
  GPIO_InitStruct.Pin = GPIO_OUT1_Pin|GPIO_OUT7_Pin|GPIO_OUT6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

  /*Configure GPIO pins : GPIO_OUT3_Pin GPIO_OUT4_Pin */
  GPIO_InitStruct.Pin = GPIO_OUT3_Pin|GPIO_OUT4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : GPIO_OUT5_Pin */
  GPIO_InitStruct.Pin = GPIO_OUT5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIO_OUT5_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : EXT_SWITCH_Pin */
  GPIO_InitStruct.Pin = EXT_SWITCH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(EXT_SWITCH_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : BNO085_H_INTN_Pin */
  GPIO_InitStruct.Pin = BNO085_H_INTN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BNO085_H_INTN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : GPIO_IN3_Pin */
  GPIO_InitStruct.Pin = GPIO_IN3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIO_IN3_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : GPIO_IN4_Pin GPIO_IN5_Pin GPIO_IN6_Pin */
  GPIO_InitStruct.Pin = GPIO_IN4_Pin|GPIO_IN5_Pin|GPIO_IN6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pin : BNO085_NRST_Pin */
  ...
  /*Configure GPIO pins : PYRO_FIRE1_Pin PYRO_FIRE2_Pin PYRO_FIRE3_Pin PYRO_FIRE4_Pin
                           PYRO_FIRE5_Pin BLE_RESET_N_Pin */
  GPIO_InitStruct.Pin = PYRO_FIRE1_Pin|PYRO_FIRE2_Pin|PYRO_FIRE3_Pin|PYRO_FIRE4_Pin
                          |PYRO_FIRE5_Pin|BLE_RESET_N_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : BLE_SWITCH2_Pin BLE_SWITCH1_Pin BLE_DSR_Pin CS_SPI_EXT_Pin */
  GPIO_InitStruct.Pin = BLE_SWITCH2_Pin|BLE_SWITCH1_Pin|BLE_DSR_Pin|CS_SPI_EXT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : CS_LSM6DSV16B_Pin CS_MMC5983_Pin CS_ADXL375_Pin */
  GPIO_InitStruct.Pin = CS_LSM6DSV16B_Pin|CS_MMC5983_Pin|CS_ADXL375_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pin : BLE_DTR_Pin */
  GPIO_InitStruct.Pin = BLE_DTR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(BLE_DTR_GPIO_Port, &GPIO_InitStruct);

  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(BNO085_H_INTN_EXTI_IRQn, 4, 0);
  HAL_NVIC_EnableIRQ(BNO085_H_INTN_EXTI_IRQn);

  HAL_NVIC_SetPriority(BLE_DTR_EXTI_IRQn, 4, 0);
  HAL_NVIC_EnableIRQ(BLE_DTR_EXTI_IRQn);

  HAL_NVIC_SetPriority(LSM6_INT1_EXTI_IRQn, 4, 0);
  HAL_NVIC_EnableIRQ(LSM6_INT1_EXTI_IRQn);

  HAL_NVIC_SetPriority(SD_DET_EXTI_IRQn, 9, 0);
  HAL_NVIC_EnableIRQ(SD_DET_EXTI_IRQn);

  HAL_NVIC_SetPriority(USB_VBUS_EXTI_IRQn, 9, 0);
  HAL_NVIC_EnableIRQ(USB_VBUS_EXTI_IRQn);

  HAL_NVIC_SetPriority(EXT_SWITCH_EXTI_IRQn, 9, 0);
  HAL_NVIC_EnableIRQ(EXT_SWITCH_EXTI_IRQn);
...
void MPU_Config(void)
{
  ...
  */
  ...
  MPU_InitStruct.BaseAddress = 0x2001BF00;
